...
export const WILAYAS_REAL: WilayaData[] = [
  ...
  { id: '02', name: 'CHLEF', zone: 'III', tiv: 614287620.00, primeNette: 520726.26, expectedLoss: 454572.84, difference: -66153.42, pga: 0.15, iv: 0.4, status: 'Balanced' },
  ...
  { id: '09', name: 'BLIDA', zone: 'III', tiv: 10514700299.21, primeNette: 5125325.80, expectedLoss: 7780878.22, difference: 2655552.42, pga: 0.15, iv: 0.4, status: 'High Risk' },
  ...
  { id: '16', name: 'ALGER', zone: 'III', tiv: 100424548250.16, primeNette: 56670572.31, expectedLoss: 74314165.71, difference: 17643593.40, pga: 0.15, iv: 0.4, status: 'Hotspot' },
  ...
  { id: '26', name: 'MEDEA', zone: 'III', tiv: 3574859548.20, primeNette: 2127904.74, expectedLoss: 2645396.07, difference: 517491.33, pga: 0.15, iv: 0.4, status: 'High Risk' },
  ...
  { id: '28', name: 'M SILA', zone: 'IIb', tiv: 2078396130.00, primeNette: 1535516.80, expectedLoss: 2138669.62, difference: 603152.82, pga: 0.15, iv: 0.4, status: 'High Risk' },
  { id: '29', name: 'MASCARA', zone: 'IIa', tiv: 3365902403.63, primeNette: 2369678.15, expectedLoss: 1312701.94, difference: -1056976.21, pga: 0.15, iv: 0.4, status: 'Safe' },
  { id: '30', name: 'OURGLA', zone: 'IIb', tiv: 100529760.00, primeNette: 61454.37, expectedLoss: 103445.12, difference: 41990.76, pga: 0.15, iv: 0.4, status: 'High Risk' },
  { id: '31', name: 'ORAN', zone: 'IIa', tiv: 31414400043.22, primeNette: 12181053.54, expectedLoss: 12251616.02, difference: 70562.48, pga: 0.15, iv: 0.4, status: 'High Risk' },
  { id: '32', name: 'EL BAYADH', zone: 'I', tiv: 1000000.00, primeNette: 2500.00, expectedLoss: 110.00, difference: -2390.00, pga: 0.15, iv: 0.4, status: 'Balanced' },
  ...
  { id: '35', name: 'BOUMERDES', zone: 'IIb', tiv: 15746649379.50, primeNette: 7770587.37, expectedLoss: 16203302.21, difference: 8432714.84, pga: 0.15, iv: 0.4, status: 'Hotspot' },
  { id: '36', name: 'EL TAREF', zone: 'I', tiv: 6905131270.49, primeNette: 2000473.69, expectedLoss: 759564.44, difference: -1240909.25, pga: 0.15, iv: 0.4, status: 'Safe' },
  { id: '38', name: 'TISSEMSILT', zone: 'I', tiv: 364310849.20, primeNette: 109712.34, expectedLoss: 40074.19, difference: -69638.14, pga: 0.15, iv: 0.4, status: 'Balanced' },
  { id: '39', name: 'El Oued', zone: 'IIb', tiv: 799076687.00, primeNette: 391929.82, expectedLoss: 822249.91, difference: 430320.09, pga: 0.15, iv: 0.4, status: 'High Risk' },
  { id: '40', name: 'KHENCHELA', zone: 'IIb', tiv: 503961200.00, primeNette: 363177.13, expectedLoss: 518576.07, difference: 155398.94, pga: 0.15, iv: 0.4, status: 'High Risk' },
  { id: '41', name: 'SOUK AHRAS', zone: 'III', tiv: 21090650.00, primeNette: 17490.82, expectedLoss: 40915.86, difference: 23425.04, pga: 0.15, iv: 0.4, status: 'High Risk' },
  { id: '42', name: 'TIPAZA', zone: 'IIa', tiv: 4477231990.00, primeNette: 3561386.01, expectedLoss: 1746120.48, difference: -1815265.53, pga: 0.15, iv: 0.4, status: 'Safe' },
  { id: '43', name: 'MILA', zone: 'III', tiv: 4311404348.00, primeNette: 2695490.83, expectedLoss: 3190439.22, difference: 494948.39, pga: 0.15, iv: 0.4, status: 'High Risk' },
